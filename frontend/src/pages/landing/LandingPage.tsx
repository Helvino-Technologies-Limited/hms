...
const testimonials = [
  { name: 'Dr. Sarah Kamau', role: 'Chief Medical Officer', quote: 'This HMS transformed how we manage patient care. The integrated clinical workflow saves us hours every day.' },
      ...
      <section id="testimonials" className="py-20 px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-500">What our users say about our HMS</p>
          </div>
