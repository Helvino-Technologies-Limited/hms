...
const testimonials = [
  { name: 'Dr. Sarah Kamau', role: 'Chief Medical Officer', quote: 'Helvino Technologies Limited transformed how we manage patient care. The integrated clinical workflow saves us hours every day.' },
      ...
      <section id="testimonials" className="py-20 px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-500">What our users say about Helvino Technologies Limited</p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div className="md:col-span-2">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xl font-bold">Helvino Technologies Limited</span>
              </div>
